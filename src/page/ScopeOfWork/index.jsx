...
function ScopeOfWork() {
  ...
  const LoginValidation = yup.object({
    StatUs: yup.string().required('Scope Of Work is required.'),
  })
  useEffect(() => {
      ...
      <div className="row">
        <div className="col-12">
          <div className="d-flex justify-content-between align-items-center pt-4">
            <div className="">
              <h4 className=''><b>Scope Of Work</b></h4>
            </div>
      ...
      >
        ...
        <Formik
          ...
          onSubmit={(values) => {
            ...
            setvalidationActive(false)
            if (!buttomclick) {
              toast.success('Scope Of Work Add successFully.')
            }
          }}
        >
          {({
            ...
            <>
              <Form >
                <Modal.Body>
                  <div className="mb-3">
                    <div className="">
                      <label className='py-1'>Scope Of Work <span className='error'>*</span></label>
                ...
                <Modal.Footer>
                  <div className="col-12 d-flex justify-content-center">
                    <button className='btn btn-outline-info px-3 py-2 my-3 mx-2' style={{ width: '110px' }} type='submit' onClick={onDone}>
                      Save
                    </button>
